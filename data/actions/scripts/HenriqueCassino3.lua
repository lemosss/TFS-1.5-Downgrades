local positions = {{x = 32344, y = 32231, z = 4}, {x = 32344, y = 32230, z = 4}, {x = 32344, y = 32229, z = 4}} -- Posicao q os items nascem
local price = 1 -- Preco para jogar
local eventcoins = 8426
local items = {8348, 8419, 8429}
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if getGlobalStorageValue(722403) > os.time() then
    ...
    if getPlayerStorageValue(cid,722404) > os.time() then
        doPlayerSendCancel(cid,"wait 3 seconds to new bet.")
        return true
    end
    doPlayerSetStorageValue(cid,722404,os.time()+6)
    
    setGlobalStorageValue(722403, os.time() + 6)
