local positions = {{x = 32354, y = 32225, z = 4}, {x = 32354, y = 32226, z = 4}, {x = 32354, y = 32227, z = 4}} -- Posicao q os items nascem
local price = 1 -- Preco para jogar
local eventcoins = 8426
local items = {5806, 2408, 2646}
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if getGlobalStorageValue(722407) > os.time() then
    ...
    if getPlayerStorageValue(cid,722408) > os.time() then
        doPlayerSendCancel(cid,"wait 3 seconds to new bet.")
        return true
    end
    doPlayerSetStorageValue(cid,722408,os.time()+6)
    
    setGlobalStorageValue(722407, os.time() + 6)
