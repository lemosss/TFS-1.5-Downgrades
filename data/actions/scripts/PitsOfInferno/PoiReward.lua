...
elseif item.actionid == 10004 then
	if getPlayerStorageValue(cid,10004) <= 0 then
		doPlayerSendTextMessage(cid,22,"You have found a backpack of holding, 100 power bolt and bless ankh.")
		local backpack = doPlayerAddItem(cid, 5819, 1)
		doAddContainerItem(backpack, 2547, 100)
		doAddContainerItem(backpack, 2152, 100)
		doAddContainerItem(backpack, 5807, 1)
