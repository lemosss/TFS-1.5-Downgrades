local positions = {{x = 32344, y = 32227, z = 4}, {x = 32344, y = 32226, z = 4}, {x = 32344, y = 32225, z = 4}} -- Posicao q os items nascem
local price = 1 -- Preco para jogar
local eventcoins = 8426
local items = {8098, 8120, 8101}
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if getGlobalStorageValue(722401) > os.time() then
    ...
    if getPlayerStorageValue(cid,722402) > os.time() then
        doPlayerSendCancel(cid,"wait 3 seconds to new bet.")
        return true
    end
    doPlayerSetStorageValue(cid,722402,os.time()+6)
    
    setGlobalStorageValue(722401, os.time() + 6)
