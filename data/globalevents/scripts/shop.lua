            ...
            if isPlayer(cid) == TRUE then
                ...
                if full_weight <= free_cap then
                    if add_item_type == 'container' then
						...
						doItemSetAttribute(new_container, "description", 'PROTECTION SYSTEM: [' .. getCreatureName(cid) .. ' - ID:' .. um .. '' .. dois .. '' .. tres .. '' .. quatro .. ']')
                        local iter = 0
                        while iter ~= container_count do
							local new_item = doCreateItemEx(itemtogive_id, itemtogive_count)
							doItemSetAttribute(new_item, "description", 'PROTECTION SYSTEM: [' .. getCreatureName(cid) .. ' - ID:' .. um .. '' .. dois .. '' .. tres .. '' .. quatro .. ']')
                            doItemSetAttribute(new_item, "donate", 1)
