...
local function creatureSayCallback(cid, type, msg)
	...
	if (msgcontains(msg, 'bring') and msgcontains(msg, 'me') and msgcontains(msg, 'to') and msgcontains(msg, 'svarsadafas') and (not npcHandler:isFocused(cid))) then
	...
	elseif (msgcontains(msg, 'bring') and msgcontains(msg, 'me') and msgcontains(msg, 'to') and msgcontains(msg, 'svargasdasdrond') and (not npcHandler:isFocused(cid))) then
		if doPlayerRemoveMoney(cid, 60) == TRUE then
		doTeleportThing(cid,{x = 32871, y = 31024, z = 4})
		npcHandler:addFocus(cid)
		else 
