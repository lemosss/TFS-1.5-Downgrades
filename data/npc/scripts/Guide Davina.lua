...
local voices = {
	...
	{ text = 'Hello, is this your first visit to liberty? I can show you around a little.' },
	{ text = 'I can tell you all about the status this world is in.' },
	{ text = 'Talk to me if you need directions.' },
	{ text = 'Need some help finding your way through liberty?' }
}
...
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'I\'ll help you find your way through liberty, the amazon town. I can mark important locations on your map and give you some information about the town and the world status.'})
...
npcHandler:setMessage(MESSAGE_GREET, "Welcome to liberty, |PLAYERNAME| Would you like some information and a {map} guide?")
npcHandler:setMessage(MESSAGE_WALKAWAY, "Good bye.")
npcHandler:setMessage(MESSAGE_FAREWELL, "Good bye and enjoy your stay in liberty, |PLAYERNAME|")
