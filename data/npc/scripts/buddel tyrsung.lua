local keywordHandler = KeywordHandler:new()
 ...
 local function creatureSayCallback(cid, type, msg)
	...
	if (msgcontains(msg, 'bring') and msgcontains(msg, 'me') and msgcontains(msg, 'to') and msgcontains(msg, 'okolnir') and (not npcHandler:isFocused(cid))) then
	...
	return true
       ...
       local travelNode = keywordHandler:addKeyword({'barbarian'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to travel to Barbarian Camp for 60 gold coins?'})
        ...
        keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I only can offer you my services to Helheim, Okolnir, Barbarian Camp.'})
