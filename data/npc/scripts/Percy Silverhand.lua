...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			npcHandler:say({
				"Very well, maybe you know that the orcs here in liberty bay learnt to raise giant spiders. It is going to become a serious threat. ...",
...
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = "I am the governor of this isle, liberty bay, and grandmaster of the Knights of Banor's Blood."})
