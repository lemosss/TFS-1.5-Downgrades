 ...
 local function creatureSayCallback(cid, type, msg)
	...
	return true
       ...
       local travelNode = keywordHandler:addKeyword({'barbarian'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to travel to barbarian camp for 60 gold coins?'})
        ...
        keywordHandler:addKeyword({'pass'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can take you to Okolnir, Barbarian Camp, Tyrsung.'})
        keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I only can offer you my services to Okolnir, Barbarian Camp, Tyrsung.'})
