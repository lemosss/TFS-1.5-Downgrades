...
shopModule:addBuyableItem({'armor rack kit'}, 6114, 90, 1, 'armor rack kit')
shopModule:addBuyableItem({'barrel kit'}, 3919, 12, 1, 'barrel kit')
shopModule:addBuyableItem({'blue bed kit'}, 7907, 80, 1, 'blue bed kit')
shopModule:addBuyableItem({'bookcase kit'}, 6373, 70, 1, 'bookcase kit')
shopModule:addBuyableItem({'chimney kit'}, 8692, 200, 1, 'chimney kit')
shopModule:addBuyableItem({'cuckoo clock'}, 1877, 40, 1, 'cuckoo clock')
shopModule:addBuyableItem({'drawer kit'}, 3915, 18, 1, 'drawer kit')
shopModule:addBuyableItem({'god flowers'}, 2100, 5, 1, 'god flowers')
shopModule:addBuyableItem({'goldfish bowl'}, 5928, 50, 1, 'goldfish bowl')
shopModule:addBuyableItem({'green bed kit'}, 7904, 80, 1, 'green bed kit')
shopModule:addBuyableItem({'large amphora kit'}, 3931, 50, 1, 'large amphora kit')
shopModule:addBuyableItem({'oven kit'}, 6372, 80, 1, 'oven kit')
...
shopModule:addBuyableItem({'potted flower'}, 2104, 5, 1, 'potted flower')
shopModule:addBuyableItem({'purple tapestry'}, 1857, 25, 1, 'purple tapestry')
shopModule:addBuyableItem({'red bed kit'}, 7906, 80, 1, 'red bed kit')
shopModule:addBuyableItem({'sofa chair kit'}, 3905, 55, 1, 'sofa chair kit')
shopModule:addBuyableItem({'table lamp kit'}, 3924, 35, 1, 'table lamp kit')
shopModule:addBuyableItem({'treasure chest'}, 1746, 1000, 1, 'treasure chest')
shopModule:addBuyableItem({'trophy stand'}, 7936, 50, 1, 'trophy stand')
shopModule:addBuyableItem({'trunk kit'}, 3920, 10, 1, 'trunk kit')
shopModule:addBuyableItem({'wall mirror'}, 1851, 40, 1, 'wall mirror')
shopModule:addBuyableItem({'wall mirror'}, 1848, 40, 1, 'wall mirror')
shopModule:addBuyableItem({'wall mirror'}, 1845, 40, 1, 'wall mirror')
shopModule:addBuyableItem({'water pipe'}, 2099, 40, 1, 'water pipe')
shopModule:addBuyableItem({'weapon rack kit'}, 6115, 90, 1, 'weapon rack kit')
shopModule:addBuyableItem({'yellow bed kit'}, 7905, 80, 1, 'yellow bed kit')
