...
function craftItem(cid, message, keywords, parameters, node)
    ...
    elseif (parameters.confirm == true) then
        ...
        if #crafttable.items > 0 then
            for i = 1, #crafttable.items do
        ...
        if(getPlayerMoney(cid) >= crafttable.cost) and (items_number == #crafttable.items) then
