BossAnnihio = {
	global_storages = {
		serial = "BA_Serial", -- storage global do serial
	},

	action_ids = {
		lever = 12349, -- action id da alavanca
		chest = 12350, -- action id do bau
	},

	death_event = "BossAnniDeathh", -- nome do evento de death do creaturescripts
	min_players = 1, -- minimo de jogadores para poder ir
	time_limit = 15, -- limite de tempo em minutos

	exit_position = {x = 32771, y = 32242, z = 10}, -- posição de saida

	places = {
		boss_room = {
			-- sala do boss
			destination = {x = 32751, y = 32230, z = 10}, -- posição do destino (onde boss é criado)
			area = {from = {x = 32745, y = 32226, z = 10}, to = {x = 32756, y = 32245, z = 10}} -- area
		},
		reward_room = {
			-- sala de recompensa
			destination = {x = 32786, y = 32225, z = 10}, -- posição do destino (onde os players vão)
			area = {from = {x = 32783, y = 32220, z = 10}, to = {x = 32790, y = 32226, z = 10}} -- area
		},
	},

	tiles = {
		-- posição do piso e destino
		{position = {x = 32765, y = 32240, z = 10}, destination = {x = 32748, y = 32244, z = 10}},
		{position = {x = 32765, y = 32241, z = 10}, destination = {x = 32749, y = 32244, z = 10}},
		{position = {x = 32765, y = 32242, z = 10}, destination = {x = 32750, y = 32244, z = 10}},
		{position = {x = 32765, y = 32243, z = 10}, destination = {x = 32751, y = 32244, z = 10}},
		{position = {x = 32765, y = 32244, z = 10}, destination = {x = 32752, y = 32244, z = 10}}
	},
	...
	bosses = {
		...
		{name = "Warrior Titan", chance = 33.33},
		{name = "Demon Darakan", chance = 33.33},
		{name = "Sea Wash Serpent", chance = 33.33},
	},

	rewards = {
		-- recompensas que podem vir ao pegar o bau
		{id = "8350", count = {10, 1}, chance = 99},
		{id = "2160", count = {3, 1}, chance = 45},
		{id = "2488", count = {1, 1}, chance = 15.5},
		{id = "2466", count = {1, 1}, chance = 15},
		{id = "2195", count = {1, 1}, chance = 10.5},
		{id = "2492", count = {1, 1}, chance = 10},
		{id = "5792", count = {1, 1}, chance = 3.5},
		{id = "8150", count = {1, 1}, chance = 3},
		{id = "5797", count = {1, 1}, chance = 2.5},
		{id = "5796", count = {1, 1}, chance = 2},
		{id = "5793", count = {1, 1}, chance = 1.5},
		{id = "8367", count = {6, 1}, chance = 1},
		{id = "8380", count = {1, 1}, chance = 0.5},
	},
...
do
	local str = ""
	for i = 1, #BossAnnihio.items_needed do
		local item = BossAnnihio.items_needed[i]
	...
	BossAnnihio.items_description = (str:sub(1, #str - 2):gsub("(.+), ", "%1 e ", 1))
end

math.randomseed(os.mtime())

function BossAnnihio:genSerial()
	local serial = "S"
	for _ = 1, 11 do
...
function BossAnnihio:getSerial()
	return getStorage(self.serial_storage)
end

function BossAnnihio:getSpectators(place, getPlayers, getMonsters)
...
function BossAnnihio:getRandomBoss()
	local chance = nil
...
function BossAnnihio:createBoss(name)
...
-- CALLBACKS
function BossAnnihio:onUse(cid, item, fromPosition, itemEx, toPosition, isHotkey)
	-- Alavanca
...
function BossAnnihio:onDeath(cid, corpse, deathList)
	local creatures = self:getSpectators("boss_room", true, true)
	for i = 1, #creatures do
